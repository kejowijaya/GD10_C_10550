...
import com.example.gd10_c_10550.databinding.ListDataMahasiswaBinding

class MahasiswaAdapter (
    private val listMahasiswa:ArrayList<MahasiswaData>,
    private val context: Context): RecyclerView.Adapter<MahasiswaAdapter.MahasiswaViewHolder>() {
